...
export default {
    ...
    data() {
        return {
            ...
            form: {
                ...
                comments: this.candidate.comments,
                interview_by: this.candidate.interview_by,
                interview_feedback: this.candidate.interview_feedback,
                interview_scheduled_at: this.candidate.interview_scheduled_at ?? new Date(),
                is_selected: this.candidate.is_selected == 0 ? "false" : "true",
                agency_id: this.candidate.agency_id,
                cv_resume_file: '',
            },
        };
    },
    ...
    methods: {
        ...
        updateCandidate() {
            ...
            axios.post(route('candidates.update', this.candidate.id), formData)
                .then(res => {
...
<template>
    ...
    <BreezeAuthenticatedLayout>
        ...
        <div class="max-w-5xl bg-white rounded-md shadow overflow-x-auto mt-8">
            <CustomForm formType="edit" @update="updateCandidate" submitButtonText="Edit Candidate" :processing="this.processing">
                <template #formFields>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
                            ...
                            <div class="flex items-center">
                                <label for="is_selected" class="mt-5 block font-semibold text-gray-700">
                                    <input type="checkbox" class="form-checkbox rounded focus:outline-none focus:ring-0" id="is_selected" v-model="this.form.is_selected" />
